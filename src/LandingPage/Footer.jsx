...
const Footer = () => (
    <div>
        <div className='bg-blue m-scroll w-full sm:w-[765px] lg:w-[1152px] 2xl:w-[1252px]'>
            <div className='m-scroll__title'>
                <div>
                    <h6>
                        <span>
                            User Interface Design | User Experience Design |
                            Mobile & Web | Apps | Prototype | Wireframe |
                            Branding | Mockup | Persona |
                        </span>
                    </h6>
                    <h6>
                        <span>
    ...
    justify-around py-[5%]'
        >
            ...
            <div className='font-Poppins sm:justify-center justify-end lg:justify-end font-light text-[8px] sm:text-xs text-center flex flex-col max-w-[60vw] lg:max-w-[330px] sm:px-2 lg:p-9'>
                <span>
                    I am sure you see the “made with love” thing, but I
                    guarantee this website is made with love, so much love.
                </span>
                <hr className='bg-black my-1'></hr>
                <div className='inline-flex justify-center items-center'>
                    <span>
                        {' '}
                        All rights are reserved and protected by Tiera.
                    </span>
                    <Heart className='w-4' />
                </div>
            </div>
