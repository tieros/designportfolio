                ...
                <div className='bg-[#f7f7ef] lg:bg-bg rounded-lg p-10 basis-full lg:basis-2/4 flex flex-col lg:px-[60px] gap-10'>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        <p className='font-Poppins'>
                            Mobile app design where users can send and receive
                            money among friends, with digital payment. Checkout
                            the branding, flows, wireframes and prototypes.
                        </p>
                    </div>
                ...
                <div className='bg-[#f7f7ef] lg:bg-bg rounded-lg  p-10 basis-full lg:basis-2/4 flex flex-col lg:px-[60px] gap-10'>
                    ...
                    <div className='flex flex-col gap-5'>
                        <img
                            ...
                            className='lg:hidden'
                        />
                        <h4 className='font-Poppins font-semibold'>Sparky</h4>
                        <p className='font-Poppins'>
                            Enhanced the Philips Lumea epilation tracking app
                            with a fresh and gender inclusive design, ensuring a
                            clean and user-friendly experience.
